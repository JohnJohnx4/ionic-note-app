...
var NotesService = /** @class */ (function () {
    ...
    NotesService.prototype.getSingleNote = function (noteId) {
    ...
    NotesService.prototype.addNote = function (note) {
        ...
        return this.http.post(this.ROOT_URL + "/api/notes", { title: title, content: content, user: testUser._id }, httpOptions);
    };
    NotesService.prototype.deleteNote = function (noteId) {
        return this.http.delete(this.ROOT_URL + "/api/notes/" + noteId);
    };
    NotesService.prototype.editNote = function (note, noteId) {
        var title = note.title, content = note.content;
        return this.http.put(this.ROOT_URL + "/api/notes/" + noteId, { title: title, content: content }, httpOptions);
    };
